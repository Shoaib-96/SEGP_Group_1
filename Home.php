...
<div class="w3-main" style="margin-left:283px">
  ...
  <div id="id03" class="modal">
	  	...
	  	<form class="modal-content animate" action="changepass.php" style="width:400px" method="post" enctype="multipart/form-data">
			...
			<div class="container" style="width:100%;">
			  <label><b>Name:<?php echo" ".$_SESSION['username']  ?></b></label><br>
			  <br>
			  <label><b>Department:<?php echo" ".$_SESSION['department']  ?> </b></label><br>
			  <br>
			  <label><b>Email:<?php echo" ".$_SESSION['email']  ?></b></label><br>
			  <br>
			  
			  <label>Change Password</label>
			  <div class = "changePassword boxShow">
					<input type="password" placeholder="Enter new Password" name="npw" id="npw" value="<?php echo $_SESSION['psw'] ?>" onchange='check_pass();' required>
					<br>
					<input type="password" placeholder="Confirm new Password" name="cpw" id="cpw" value="<?php echo $_SESSION['psw'] ?>" onchange='check_pass();' required>
			  </div>
			  <button type="submit" name="submit" id="submit" disabled>Save</button>
			</div>
...
/*function Validate() {
	...
	function check_pass(){
	if(document.getElementById('epw').value == <?php echo $_SESSION['psw']?> ){
